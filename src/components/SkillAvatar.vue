...
.color-blue.is_gained       .avatar .q-avatar { background: linear-gradient(to top, $blue-10, $blue-8); box-shadow: inset 0px 0px 0px 2px $blue;}
.color-blue.is_available    .avatar .q-avatar { background: linear-gradient(to top, $grey-10, $grey-9); box-shadow: inset 0px 0px 0px 2px $grey-3;}
.color-blue.is_purchasable  .avatar .q-avatar { box-shadow: inset 0px 0px 0px 2px $blue;}
...
.color-blue.is_gained.skill-block:before { border-color: $blue; border-width: 3px; }

.color-orange.is_gained       .avatar .q-avatar { background: linear-gradient(to top, $orange-10, $orange-8);  box-shadow: inset 0px 0px 0px 2px $orange;}
.color-orange.is_available    .avatar .q-avatar { background: linear-gradient(to top, $grey-10, $grey-9);box-shadow: inset 0px 0px 0px 2px $orange-3;}
...
.color-orange.is_gained.skill-block:before { border-color: $orange; border-width: 3px;}
</style>
